--[[
	...
	USAGE:
	- use it with isc_database_info() to encode the info request and decode the info result.
...
function decode(info_buf, info_buf_len, fbapi) --yeah, some decoder wants a fbapi, just pass it on and fuggetaboutit
